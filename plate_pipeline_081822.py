#this set of functions completely analyzes a glass plate, you can transform the plate with an equation or by utilizing the low PSF of galaxies to compare fluxes with SDSS. Running this results in a catalog of matched sources against Gaia.
